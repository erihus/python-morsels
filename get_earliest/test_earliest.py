...
from earliest import my_get_earliest, solution_get_earliest


class GetEarliestTests(unittest.TestCase):

    """Tests for my_get_earliest."""
    ...
    ##Test solution version
    def solution_test_same_month_and_day(self):
        newer = "01/27/1832"
        older = "01/27/1756"
        self.assertEqual(solution_get_earliest(newer, older), older)

    def solution_test_february_29th(self):
        newer = "02/29/1972"
        older = "12/21/1946"
        self.assertEqual(solution_get_earliest(newer, older), older)

    def solution_test_smaller_month_bigger_day(self):
        newer = "03/21/1946"
        older = "02/24/1946"
        self.assertEqual(solution_get_earliest(older, newer), older)

    def solution_test_same_month_and_year(self):
        newer = "06/24/1958"
        older = "06/21/1958"
        self.assertEqual(solution_get_earliest(older, newer), older)

    def solution_test_invalid_date_allowed(self):
        newer = "02/29/2006"
        older = "02/28/2006"
        self.assertEqual(solution_get_earliest(older, newer), older)

    def solution_test_two_invalid_dates(self):
        newer = "02/30/2006"
        older = "02/29/2006"
        self.assertEqual(solution_get_earliest(newer, older), older)
